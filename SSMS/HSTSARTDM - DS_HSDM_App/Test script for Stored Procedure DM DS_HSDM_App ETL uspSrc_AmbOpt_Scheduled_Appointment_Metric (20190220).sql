...
SET @startdate = NULL
SET @enddate = NULL
--SET @startdate = '9/1/2018 00:00 AM'
--SET @enddate = '10/1/2018 00:00 AM'
...
--For tableau calc purposes null = 0 per Sue.
	   ...
	   evnts.CHANGE_DATE, -- DATETIME
	   evnts.Cancel_Lead_Days -- INTEGER
...
-- Assumes that there is always a referral creation date (CHANGE_DATE) documented when a referral entry date (ENTRY_DATE) is documented
        ...
        ( --main
			...
			--AND appts.PAT_ENC_CSN_ID = 70429558
