...
CREATE PROCEDURE [ETL].[uspLoad_Scheduled_Appointment]
(
...
WHO : Tom Burgan
WHEN: 11/29/2017
WHY : Load staging table (HSTSDSSQLDMT DS_HSDM_App_Dev Stage.Scheduled_Appointment) containing Cadence scheduled appointment detail.
      To facilitate the development of the stored procedures for the Ambulatory Optimization metrics.
----------------------------------------------------------------------------------------------------------------------------------------
INFO: 
      INPUTS:	HSTSECLARITYT.CLARITY.dbo.V_SCHED_APPT
	            HSTSECLARITYT.CLARITY.dbo.PAT_ENC
				HSTSECLARITYT.CLARITY.dbo.PAT_ENC_4
				HSTSECLARITYT.CLARITY.dbo.CLARITY_DEP
				HSTSECLARITYT.CLARITY.dbo.PAT_ENC_3
				HSTSECLARITYT.CLARITY.dbo.V_COVERAGE_PAYOR_PLAN
				HSTSECLARITYT.CLARITY.dbo.PATIENT_MYC
				HSTSECLARITYT.CLARITY.dbo.CLARITY_SER
				HSTSECLARITYT.CLARITY.dbo.IDENTITY_ID
				HSTSECLARITYT.CLARITY.dbo.REFERRAL
				HSTSECLARITYT.CLARITY.dbo.ZC_MYCHART_STATUS
				HSTSECLARITYT.CLARITY.dbo.ZC_RFL_STATUS
				HSTSECLARITYT.CLARITY.dbo.ZC_RFL_TYPE
				HSTSECLARITYT.CLARITY.dbo.ZC_SPECIALTY
				HSTSECLARITYT.CLARITY.dbo.ZC_DISP_ENC_TYPE
                  
      OUTPUTS:  CLARITY_App_Dev.ETL.uspLoad_Scheduled_Appointment
